...
def build_reconstruction_prompt() -> str:
    ...
    return (
        ...
        "Every object, relationship, group, legend, and note/callout annotation must cite "
        "visual evidence. Preserve exact visible annotation text and record any visibly "
