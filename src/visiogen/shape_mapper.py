...
_NODE_VISUALS: dict[NodeType, NodeVisualSpec] = {
    "terminator": _node("terminator", 2.2, 0.75),
    "process": _node("process", 2.25, 0.65),
    "decision": _node("decision", 2.0, 1.25),
    "input_output": _node("input_output", 2.5, 0.9),
    "data_store": _node("database", 2.2, 1.15),
    "document": _node("document", 2.3, 1.0),
    "predefined_process": _node("predefined_process", 2.5, 0.85),
    "delay": _node("delay", 2.2, 0.9),
    "note": _node("note", 2.3, 1.0),
    "connector_hub": _node("connector_hub", 1.1, 1.1),
    "component": _node("component_rectangle", 2.75, 0.8),
    "subsystem": _node("subsystem_container", 5.0, 2.5, container=True),
    "controller": _node("controller", 2.4, 0.9),
    "processor": _node("controller", 2.4, 0.9),
    "memory": _node("database", 2.2, 1.15),
    "database": _node("database", 2.2, 1.15),
    "sensor": _node("sensor", 1.4, 1.4),
    "actuator": _node("component_rectangle", 2.75, 0.8),
    "transducer": _node("sensor", 1.4, 1.4),
    "power_source": _node("power_source", 2.3, 1.1),
    "communication_module": _node("component_rectangle", 2.75, 0.8),
    "interface": _node("interface", 2.4, 0.5),
    "external_system": _node("external_system", 2.6, 1.0),
    "service": _node("external_system", 2.6, 1.0),
    "housing": _node("housing_container", 5.5, 2.6, container=True),
}
