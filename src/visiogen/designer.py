...
def build_design_prompt() -> str:
    ...
    return (
        ...
        "When the input is a validated DiagramSpecification, preserve its required objects, "
        "relationships, exact labels, unknowns, and hard constraints. "
        ...
        "components and relationships supported by the source. Preserve explicitly recorded "
        "ambiguity instead of silently resolving it. Avoid parallel connectors between the same two nodes "
